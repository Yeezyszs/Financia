...
export class Account {
  constructor(private readonly props: AccountProps) {
    ...
    if (props.type !== 'credit_card' && props.settlementAccountId) {
      throw new DomainError(
        'Somente cartão de crédito tem conta de quitação',
        'INVALID_ACCOUNT',
      );
    }
  }
  ...
  get institution(): Institution { return this.props.institution; }
  get currency(): string { return this.props.currency; }
  get settlementAccountId(): string | null { return this.props.settlementAccountId; }
  get isActive(): boolean { return this.props.isActive; }

  get isCreditCard(): boolean { return this.props.type === 'credit_card'; }
